jQuery(window).on('load', function () {
	...
	if (
		...
		jQuery('.testimonial-two-dots').length > 0)
	)
		var e = new Swiper('.testimonial-two-dots', {
			loop: !0,
			spaceBetween: 30,
			slidesPerView: 3,
			autoplay: { delay: 3e3 },
	...
	if (jQuery('.home-slider5').length > 0)
		var e = new Swiper('.home-slider5', {
			loop: !0,
			effect: 'fade',
			slidesPerView: 'auto',
			autoplay: { delay: 3e3 },
	...
	if (
		$('.project-thumb-swiper').length > 0 &&
		$('.project-list-swiper').length > 0
	) {
		var e = new Swiper('.project-thumb-swiper', {
			loop: !1,
			spaceBetween: 10,
			slidesPerView: 4,
			freeMode: !0,
		...
		new Swiper('.project-list-swiper', {
			loop: !0,
			autoplay: { delay: 3e3 },
			spaceBetween: 10,
			thumbs: { swiper: e },

<div class="relative mb-7.5 overflow-hidden">
						<div
							class="relative overflow-hidden rounded md:w-[350px] w-full table-cell align-top group">
							<a href="<?php  echo the_permalink() ?>">
								<img src="<?php gnws_post_thumbnail_full() ?>" alt="<?php the_title() ?>" class="block duration-[10s] group-hover:scale-125 object-cover aspect-square">

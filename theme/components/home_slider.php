    ...
    <div class="main-banner">
        <div class="swiper home-slider2 owl-carousel w-full">
            ...
            <?php while (have_rows('list_slider')):
                the_row(); ?>
                <div class="bg-no-repeat bg-cover bg-[50%] sm:!h-[90vh] !h-[60vh] relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:size-full after:-z-1 after:min-h-[400px] after:bg-[linear-gradient(rgba(0,0,0,0)_0%,_rgba(0,0,0,0.60)_100%)]"
                    style="background-image: url('<?php the_sub_field('banner_slider') ?>');">
                    <div class="absolute left-0 bottom-0 md:p-13.5 p-7.5">
                        <?php if (get_sub_field('title')): ?>

                            <h2 class="font-semibold xl:text-[90px]/[90px] sm:text-[67px]/[61px] text-3xl/9 mb-4 text-white">

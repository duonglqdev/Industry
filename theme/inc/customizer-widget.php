...
class GNWS_Gallery_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <div class="mb-7.5">
            <?php if ($title): ?>
                <h5 class="relative align-middle uppercase border-b border-black/15 mb-5 pb-3.75 font-semibold leading-3 after:-bottom-0.5 after:content-[''] after:inline-block after:h-[3px] after:left-0 after:absolute after:align-bottom after:w-13.5 after:bg-primary">
                    ...
                    <?php foreach ($gallery as $image_id): ?>
                        <li class="inline-block float-left w-1/4 p-0.5 duration-500 hover:opacity-70">
                            <div class="relative overflow-hidden">
                                <a href="<?php echo esc_url(wp_get_attachment_url($image_id)); ?>" data-fancybox="gallery" class="mfp-image">
            ...
            <?php endif; ?>
                <div class="widget-project-box owl-none owl-loaded owl-theme owl-carousel dots-style-1 owl-dots-black-full">
                    <?php foreach ($galleryProject as $image_id): ?>
                        <div class="item">
                            <a href="<?php echo esc_url(wp_get_attachment_url($image_id)); ?>" data-fancybox="gallery-pj" class="mfp-image">
                                <?php echo wp_get_attachment_image($image_id, 'full', false, ['class' => 'aspect-square object-cover size-full']); ?>
                            </a>
                        </div>
                    <?php endforeach; ?>
